...
function createLabel(tags,num){
   ...
   if(tags.length !== 0){
        ...
        labels = ['101','102','103','104','105','106','107','108','109','110','111','112','113','114'];
    }
...
//console.log(labels)
    ...
    for(var i = 0;i < n;i++){
        ...
        html += "<div class='label_item'><img src='images/"+labels[index]+".jpg'/></div>";
    }
...
function move(elements){
    var degreeX = Math.PI/100 * 0.3 * 2;
    var degreeY = Math.PI/100 * 0.3 * 2;
    var container = document.getElementById('container');
    var x,y;
    var timer;
    x = y = 2;
...
//        console.log(e.clientX-this.offsetLeft + ' '+ e.clientY)
        ...
        y = (e.clientY - 210)/300;
        degreeX = Math.PI/100 * x * 2;
        degreeY = Math.PI/100 * y * 2;
    })
